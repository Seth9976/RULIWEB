...
public final class MutableFloatFloatMap extends FloatFloatMap {
    ...
    public MutableFloatFloatMap(int v, int v1, DefaultConstructorMarker defaultConstructorMarker0) {
        if((v1 & 1) != 0) {
            v = 6;
        }
        this(v);
    ...
    public final float getOrPut(float f, Function0 function00) {
        Intrinsics.checkNotNullParameter(function00, "defaultValue");
        int v = this.findKeyIndex(f);
        if(v < 0) {
            float f1 = ((Number)function00.invoke()).floatValue();
            this.put(f, f1);
            return f1;
        }
    ...
    public final void plusAssign(FloatFloatMap floatFloatMap0) {
        Intrinsics.checkNotNullParameter(floatFloatMap0, "from");
        this.putAll(floatFloatMap0);
    }

    public final float put(float f, float f1, float f2) {
        int v = this.findInsertIndex(f);
        if(v < 0) {
            v = ~v;
        }
        else {
    ...
    public final void put(float f, float f1) {
        this.set(f, f1);
    }

    public final void putAll(FloatFloatMap floatFloatMap0) {
        Intrinsics.checkNotNullParameter(floatFloatMap0, "from");
    ...
    public final boolean remove(float f, float f1) {
        int v = this.findKeyIndex(f);
        if(v >= 0 && this.values[v] == f1) {
            this.removeValueAt(v);
            return true;
        }
        return false;
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            if(((Boolean)function20.invoke(((float)this.keys[v5]), ((float)this.values[v5]))).booleanValue()) {
    ...
    private final void resizeStorage(int v) {
        ...
        float[] arr_f2 = this.keys;
        float[] arr_f3 = this.values;
