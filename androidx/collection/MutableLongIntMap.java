...
public final class MutableLongIntMap extends LongIntMap {
    ...
    public MutableLongIntMap(int v, int v1, DefaultConstructorMarker defaultConstructorMarker0) {
        if((v1 & 1) != 0) {
            v = 6;
        }
        this(v);
    ...
    public final int getOrPut(long v, Function0 function00) {
        Intrinsics.checkNotNullParameter(function00, "defaultValue");
        int v1 = this.findKeyIndex(v);
        if(v1 < 0) {
            int v2 = ((Number)function00.invoke()).intValue();
            this.put(v, v2);
            return v2;
        }
    ...
    public final void plusAssign(LongIntMap longIntMap0) {
        Intrinsics.checkNotNullParameter(longIntMap0, "from");
        this.putAll(longIntMap0);
    }

    public final int put(long v, int v1, int v2) {
    ...
    public final void put(long v, int v1) {
        this.set(v, v1);
    }

    public final void putAll(LongIntMap longIntMap0) {
        Intrinsics.checkNotNullParameter(longIntMap0, "from");
    ...
    public final boolean remove(long v, int v1) {
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            if(((Boolean)function20.invoke(((long)this.keys[v5]), ((int)this.values[v5]))).booleanValue()) {
    ...
    public final void set(long v, int v1) {
