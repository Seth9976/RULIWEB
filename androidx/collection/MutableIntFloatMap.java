...
public final class MutableIntFloatMap extends IntFloatMap {
    ...
    public MutableIntFloatMap(int v, int v1, DefaultConstructorMarker defaultConstructorMarker0) {
        if((v1 & 1) != 0) {
            v = 6;
        }
        this(v);
    ...
    public final float getOrPut(int v, Function0 function00) {
    ...
    public final void plusAssign(IntFloatMap intFloatMap0) {
        Intrinsics.checkNotNullParameter(intFloatMap0, "from");
        this.putAll(intFloatMap0);
    }

    public final float put(int v, float f, float f1) {
    ...
    public final void put(int v, float f) {
        this.set(v, f);
    }

    public final void putAll(IntFloatMap intFloatMap0) {
        Intrinsics.checkNotNullParameter(intFloatMap0, "from");
    ...
    public final boolean remove(int v, float f) {
        int v1 = this.findKeyIndex(v);
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            if(((Boolean)function20.invoke(((int)this.keys[v5]), ((float)this.values[v5]))).booleanValue()) {
    ...
    public final void set(int v, float f) {
        int v1 = this.findInsertIndex(v);
        if(v1 < 0) {
            v1 = ~v1;
        }
