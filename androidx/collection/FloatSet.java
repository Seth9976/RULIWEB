...
public abstract class FloatSet {
    ...
    public FloatSet(DefaultConstructorMarker defaultConstructorMarker0) {
    }
    ...
    public boolean equals(Object object0) {
        ...
        if(((FloatSet)object0)._size != this._size) {
            return false;
        }
        float[] arr_f = this.elements;
        long[] arr_v = this.metadata;
        ...
        if(v >= 0) {
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    int v3 = 8 - (~(v1 - v) >>> 0x1F);
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L && !((FloatSet)object0).contains(arr_f[(v1 << 3) + v4])) {
                            return false;
                        }
                        v2 >>= 8;
                    }
    ...
    public final float first(Function1 function10) {
        Intrinsics.checkNotNullParameter(function10, "predicate");
        float[] arr_f = this.elements;
        long[] arr_v = this.metadata;
        int v = arr_v.length - 2;
    ...
    public final String joinToString() {
        return FloatSet.joinToString$default(this, null, null, null, 0, null, 0x1F, null);
    }

    public final String joinToString(CharSequence charSequence0) {
        Intrinsics.checkNotNullParameter(charSequence0, "separator");
        return FloatSet.joinToString$default(this, charSequence0, null, null, 0, null, 30, null);
    }
    ...
    public final String joinToString(CharSequence charSequence0, CharSequence charSequence1) {
        ...
        return FloatSet.joinToString$default(this, charSequence0, charSequence1, null, 0, null, 28, null);
    }
    ...
    public final String joinToString(CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2) {
        ...
        return FloatSet.joinToString$default(this, charSequence0, charSequence1, charSequence2, 0, null, 24, null);
    }
    ...
    public final String joinToString(CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v) {
        ...
        Intrinsics.checkNotNullParameter(charSequence1, "prefix");
        Intrinsics.checkNotNullParameter(charSequence2, "postfix");
        return FloatSet.joinToString$default(this, charSequence0, charSequence1, charSequence2, v, null, 16, null);
    }
    ...
    public static String joinToString$default(FloatSet floatSet0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, int v1, Object object0) {
        if(object0 != null) {
        ...
        return floatSet0.joinToString(charSequence0, charSequence1, charSequence2, v, charSequence3);
    }

    public static String joinToString$default(FloatSet floatSet0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, Function1 function10, int v1, Object object0) {
        if(object0 != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: joinToString");
        }
    ...
    public String toString() {
        return FloatSet.joinToString$default(this, null, "[", "]", 0, null, 25, null);
    }
}
