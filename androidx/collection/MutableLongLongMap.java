...
public final class MutableLongLongMap extends LongLongMap {
    ...
    public final long getOrPut(long v, Function0 function00) {
    ...
    public final void plusAssign(LongLongMap longLongMap0) {
    ...
    public final void putAll(LongLongMap longLongMap0) {
        Intrinsics.checkNotNullParameter(longLongMap0, "from");
