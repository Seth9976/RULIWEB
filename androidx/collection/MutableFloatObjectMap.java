...
public final class MutableFloatObjectMap extends FloatObjectMap {
    ...
    public final Object getOrPut(float f, Function0 function00) {
    ...
    public final void plusAssign(FloatObjectMap floatObjectMap0) {
    ...
    public final Object put(float f, Object object0) {
        int v = this.findAbsoluteInsertIndex(f);
    ...
    public final void putAll(FloatObjectMap floatObjectMap0) {
        Intrinsics.checkNotNullParameter(floatObjectMap0, "from");
