...
public final class MutableIntIntMap extends IntIntMap {
    ...
    public MutableIntIntMap(int v, int v1, DefaultConstructorMarker defaultConstructorMarker0) {
        if((v1 & 1) != 0) {
            v = 6;
        }
        this(v);
    ...
    public final int getOrPut(int v, Function0 function00) {
    ...
    public final void plusAssign(IntIntMap intIntMap0) {
        Intrinsics.checkNotNullParameter(intIntMap0, "from");
        this.putAll(intIntMap0);
    }

    public final int put(int v, int v1, int v2) {
    ...
    public final void put(int v, int v1) {
        this.set(v, v1);
    }

    public final void putAll(IntIntMap intIntMap0) {
        Intrinsics.checkNotNullParameter(intIntMap0, "from");
    ...
    public final boolean remove(int v, int v1) {
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            if(((Boolean)function20.invoke(((int)this.keys[v5]), ((int)this.values[v5]))).booleanValue()) {
    ...
    public final void set(int v, int v1) {
