...
public abstract class LongIntMap {
    ...
    public LongIntMap(DefaultConstructorMarker defaultConstructorMarker0) {
    }
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            if(!((Boolean)function20.invoke(((long)arr_v[v5]), ((int)arr_v1[v5]))).booleanValue()) {
                                return false;
                            }
                        }
                        v2 >>= 8;
            ...
            for(int v1 = 0; true; ++v1) {
                ...
                if((~v3 << 7 & v3 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v5 = 0; v5 < v4; ++v5) {
                        if((0xFFL & v3) < 0x80L) {
                            int v6 = (v1 << 3) + v5;
                            if(((Boolean)function20.invoke(((long)arr_v[v6]), ((int)arr_v1[v6]))).booleanValue()) {
                                ++v2;
                            }
                        }
                        v3 >>= 8;
    ...
    public boolean equals(Object object0) {
        ...
        if(((LongIntMap)object0).getSize() != this.getSize()) {
            return false;
        }
        long[] arr_v = this.keys;
        int[] arr_v1 = this.values;
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) == 0x8080808080808080L) {
                    ...
                    while(v4 < v3) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            arr_v3 = arr_v;
                            if(arr_v1[v5] != ((LongIntMap)object0).get(arr_v3[v5])) {
                                return false;
                            }
                        }
                        else {
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            function20.invoke(((long)arr_v[v5]), ((int)arr_v1[v5]));
                        }
                        v2 >>= 8;
                    }
                    if(v3 == 8) {
    ...
    public final int getOrDefault(long v, int v1) {
        int v2 = this.findKeyIndex(v);
        return v2 < 0 ? v1 : this.values[v2];
    }

    public final int getOrElse(long v, Function0 function00) {
            ...
            for(int v1 = 0; true; ++v1) {
                ...
                if((~v3 << 7 & v3 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v5 = 0; v5 < v4; ++v5) {
                        if((0xFFL & v3) < 0x80L) {
                            int v6 = (v1 << 3) + v5;
                            v2 += arr_v1[v6] ^ UByte..ExternalSyntheticBackport0.m(arr_v[v6]);
                        }
                        v3 >>= 8;
                    }
                    if(v4 != 8) {
    ...
    public final String joinToString() {
        return LongIntMap.joinToString$default(this, null, null, null, 0, null, 0x1F, null);
    }

    public final String joinToString(CharSequence charSequence0) {
        Intrinsics.checkNotNullParameter(charSequence0, "separator");
        return LongIntMap.joinToString$default(this, charSequence0, null, null, 0, null, 30, null);
    }
    ...
    public final String joinToString(CharSequence charSequence0, CharSequence charSequence1) {
        ...
        return LongIntMap.joinToString$default(this, charSequence0, charSequence1, null, 0, null, 28, null);
    }
    ...
    public final String joinToString(CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2) {
        ...
        return LongIntMap.joinToString$default(this, charSequence0, charSequence1, charSequence2, 0, null, 24, null);
    }
    ...
    public final String joinToString(CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v) {
        ...
        Intrinsics.checkNotNullParameter(charSequence1, "prefix");
        Intrinsics.checkNotNullParameter(charSequence2, "postfix");
        return LongIntMap.joinToString$default(this, charSequence0, charSequence1, charSequence2, v, null, 16, null);
    }
    ...
    public static String joinToString$default(LongIntMap longIntMap0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, int v1, Object object0) {
        if(object0 != null) {
        ...
        return longIntMap0.joinToString(charSequence0, charSequence1, charSequence2, v, charSequence3);
    }

    public static String joinToString$default(LongIntMap longIntMap0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, Function2 function20, int v1, Object object0) {
        long[] arr_v4;
        long[] arr_v3;
        if(object0 != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: joinToString");
        ...
        long[] arr_v = longIntMap0.keys;
        int[] arr_v1 = longIntMap0.values;
        long[] arr_v2 = longIntMap0.metadata;
