...
public final class MutableFloatSet extends FloatSet {
    ...
    public final boolean add(float f) {
        int v = this._size;
        this.elements[this.findAbsoluteInsertIndex(f)] = f;
        return this._size != v;
    }

    public final boolean addAll(FloatSet floatSet0) {
    ...
    public final void plusAssign(FloatSet floatSet0) {
        Intrinsics.checkNotNullParameter(floatSet0, "elements");
        float[] arr_f = floatSet0.elements;
        long[] arr_v = floatSet0.metadata;
        int v = arr_v.length - 2;
    ...
    public final boolean removeAll(FloatSet floatSet0) {
        Intrinsics.checkNotNullParameter(floatSet0, "elements");
        int v = this._size;
