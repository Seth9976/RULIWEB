...
public abstract class FloatFloatMap {
    ...
    public FloatFloatMap(DefaultConstructorMarker defaultConstructorMarker0) {
    }
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            if(!((Boolean)function20.invoke(((float)arr_f[v5]), ((float)arr_f1[v5]))).booleanValue()) {
                                return false;
                            }
                        }
                        v2 >>= 8;
            ...
            for(int v1 = 0; true; ++v1) {
                ...
                if((~v3 << 7 & v3 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v5 = 0; v5 < v4; ++v5) {
                        if((0xFFL & v3) < 0x80L) {
                            int v6 = (v1 << 3) + v5;
                            if(((Boolean)function20.invoke(((float)arr_f[v6]), ((float)arr_f1[v6]))).booleanValue()) {
                                ++v2;
                            }
                        }
                        v3 >>= 8;
    ...
    public boolean equals(Object object0) {
        ...
        if(((FloatFloatMap)object0).getSize() != this.getSize()) {
            return false;
        }
        float[] arr_f = this.keys;
        float[] arr_f1 = this.values;
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            if(arr_f1[v5] != ((FloatFloatMap)object0).get(arr_f[v5])) {
                                return false;
                            }
                        }
                        v2 >>= 8;
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            function20.invoke(((float)arr_f[v5]), ((float)arr_f1[v5]));
                        }
                        v2 >>= 8;
                    }
                    if(v3 == 8) {
    ...
    public final float getOrDefault(float f, float f1) {
        int v = this.findKeyIndex(f);
        return v < 0 ? f1 : this.values[v];
    }

    public final float getOrElse(float f, Function0 function00) {
        Intrinsics.checkNotNullParameter(function00, "defaultValue");
        int v = this.findKeyIndex(f);
        return v >= 0 ? this.values[v] : ((Number)function00.invoke()).floatValue();
    }
    ...
    public final String joinToString() {
        return FloatFloatMap.joinToString$default(this, null, null, null, 0, null, 0x1F, null);
    }

    public final String joinToString(CharSequence charSequence0) {
        Intrinsics.checkNotNullParameter(charSequence0, "separator");
        return FloatFloatMap.joinToString$default(this, charSequence0, null, null, 0, null, 30, null);
    }
    ...
    public final String joinToString(CharSequence charSequence0, CharSequence charSequence1) {
        ...
        return FloatFloatMap.joinToString$default(this, charSequence0, charSequence1, null, 0, null, 28, null);
    }
    ...
    public final String joinToString(CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2) {
        ...
        return FloatFloatMap.joinToString$default(this, charSequence0, charSequence1, charSequence2, 0, null, 24, null);
    }
    ...
    public final String joinToString(CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v) {
        ...
        Intrinsics.checkNotNullParameter(charSequence1, "prefix");
        Intrinsics.checkNotNullParameter(charSequence2, "postfix");
        return FloatFloatMap.joinToString$default(this, charSequence0, charSequence1, charSequence2, v, null, 16, null);
    }
            ...
            while(true) {
                ...
                while(v7 < v6) {
                    if((v4 & 0xFFL) < 0x80L) {
                        ...
                        stringBuilder0.append(((CharSequence)function20.invoke(f, f1)));
                        ++v3;
                    }
                    v4 >>= 8;
                    ++v7;
    ...
    public static String joinToString$default(FloatFloatMap floatFloatMap0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, int v1, Object object0) {
        if(object0 != null) {
        ...
        return floatFloatMap0.joinToString(charSequence0, charSequence1, charSequence2, v, charSequence3);
    }

    public static String joinToString$default(FloatFloatMap floatFloatMap0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, Function2 function20, int v1, Object object0) {
        long[] arr_v2;
        long[] arr_v1;
        if(object0 != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: joinToString");
        ...
        float[] arr_f = floatFloatMap0.keys;
        float[] arr_f1 = floatFloatMap0.values;
        long[] arr_v = floatFloatMap0.metadata;
