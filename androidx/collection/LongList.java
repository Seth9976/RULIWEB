...
public abstract class LongList {
    ...
    public final boolean containsAll(LongList longList0) {
        Intrinsics.checkNotNullParameter(longList0, "elements");
        IntRange intRange0 = RangesKt.until(0, longList0._size);
        int v = intRange0.getFirst();
        int v1 = intRange0.getLast();
        if(v <= v1) {
            while(true) {
                if(!this.contains(longList0.get(v))) {
                    return false;
                }
                if(v == v1) {
                    break;
    ...
    public final long elementAt(int v) {
        if(v < 0 || v >= this._size) {
    ...
    public final long elementAtOrElse(int v, Function1 function10) {
        Intrinsics.checkNotNullParameter(function10, "defaultValue");
        return v < 0 || v >= this._size ? ((Number)function10.invoke(v)).longValue() : this.content[v];
    }
    ...
    public boolean equals(Object object0) {
        if(object0 instanceof LongList) {
            int v = this._size;
            if(((LongList)object0)._size == v) {
                long[] arr_v = this.content;
                long[] arr_v1 = ((LongList)object0).content;
    ...
    public final Object fold(Object object0, Function2 function20) {
        ...
        int v = this._size;
        for(int v1 = 0; v1 < v; ++v1) {
            object0 = function20.invoke(object0, ((long)arr_v[v1]));
        }
        return object0;
    }
    ...
    public final Object foldIndexed(Object object0, Function3 function30) {
        ...
        int v = this._size;
        for(int v1 = 0; v1 < v; ++v1) {
            object0 = function30.invoke(v1, object0, ((long)arr_v[v1]));
        }
        return object0;
    }
    ...
    public final void forEachIndexed(Function2 function20) {
        ...
        int v = this._size;
        for(int v1 = 0; v1 < v; ++v1) {
            function20.invoke(v1, ((long)arr_v[v1]));
        }
    }
    ...
    public final void forEachReversedIndexed(Function2 function20) {
        ...
        long[] arr_v = this.content;
        for(int v = this._size - 1; -1 < v; --v) {
            function20.invoke(v, ((long)arr_v[v]));
        }
    }
    ...
    public int hashCode() {
        ...
        int v2 = 0;
        for(int v1 = 0; v1 < v; ++v1) {
            v2 += UByte..ExternalSyntheticBackport0.m(arr_v[v1]) * 0x1F;
        }
        return v2;
    }

    public final int indexOf(long v) {
        long[] arr_v = this.content;
        int v1 = this._size;
        for(int v2 = 0; v2 < v1; ++v2) {
            if(v == arr_v[v2]) {
    ...
    public final String joinToString() {
        return LongList.joinToString$default(this, null, null, null, 0, null, 0x1F, null);
    }

    public final String joinToString(CharSequence charSequence0) {
        Intrinsics.checkNotNullParameter(charSequence0, "separator");
        return LongList.joinToString$default(this, charSequence0, null, null, 0, null, 30, null);
    }
    ...
    public final String joinToString(CharSequence charSequence0, CharSequence charSequence1) {
        ...
        return LongList.joinToString$default(this, charSequence0, charSequence1, null, 0, null, 28, null);
    }
    ...
    public final String joinToString(CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2) {
        ...
        return LongList.joinToString$default(this, charSequence0, charSequence1, charSequence2, 0, null, 24, null);
    }
    ...
    public final String joinToString(CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v) {
        ...
        Intrinsics.checkNotNullParameter(charSequence1, "prefix");
        Intrinsics.checkNotNullParameter(charSequence2, "postfix");
        return LongList.joinToString$default(this, charSequence0, charSequence1, charSequence2, v, null, 16, null);
    }
    ...
    public static String joinToString$default(LongList longList0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, int v1, Object object0) {
        if(object0 != null) {
        ...
        return longList0.joinToString(charSequence0, charSequence1, charSequence2, v, charSequence3);
    }

    public static String joinToString$default(LongList longList0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, Function1 function10, int v1, Object object0) {
        if(object0 != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: joinToString");
        }
        if((v1 & 1) != 0) {
    ...
    public final long last(Function1 function10) {
        Intrinsics.checkNotNullParameter(function10, "predicate");
        long[] arr_v = this.content;
        for(int v = this._size - 1; -1 < v; --v) {
            long v1 = arr_v[v];
    ...
    public final int lastIndexOf(long v) {
        long[] arr_v = this.content;
