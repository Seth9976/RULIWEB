...
public final class MutableObjectIntMap extends ObjectIntMap {
    ...
    public MutableObjectIntMap(int v, int v1, DefaultConstructorMarker defaultConstructorMarker0) {
        if((v1 & 1) != 0) {
            v = 6;
        }
        this(v);
    ...
    public final int getOrPut(Object object0, Function0 function00) {
    ...
    public final void plusAssign(ObjectIntMap objectIntMap0) {
        Intrinsics.checkNotNullParameter(objectIntMap0, "from");
        this.putAll(objectIntMap0);
    }

    public final int put(Object object0, int v, int v1) {
    ...
    public final void put(Object object0, int v) {
        this.set(object0, v);
    }

    public final void putAll(ObjectIntMap objectIntMap0) {
        Intrinsics.checkNotNullParameter(objectIntMap0, "from");
    ...
    public final boolean remove(Object object0, int v) {
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            if(((Boolean)function20.invoke(this.keys[v5], ((int)this.values[v5]))).booleanValue()) {
    ...
    public final void set(Object object0, int v) {
