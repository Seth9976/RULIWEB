...
public abstract class IntFloatMap {
    ...
    public IntFloatMap(DefaultConstructorMarker defaultConstructorMarker0) {
    }
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            if(!((Boolean)function20.invoke(((int)arr_v[v5]), ((float)arr_f[v5]))).booleanValue()) {
                                return false;
                            }
                        }
                        v2 >>= 8;
            ...
            for(int v1 = 0; true; ++v1) {
                ...
                if((~v3 << 7 & v3 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v5 = 0; v5 < v4; ++v5) {
                        if((0xFFL & v3) < 0x80L) {
                            int v6 = (v1 << 3) + v5;
                            if(((Boolean)function20.invoke(((int)arr_v[v6]), ((float)arr_f[v6]))).booleanValue()) {
                                ++v2;
                            }
                        }
                        v3 >>= 8;
    ...
    public boolean equals(Object object0) {
        ...
        if(((IntFloatMap)object0).getSize() != this.getSize()) {
            return false;
        }
        int[] arr_v = this.keys;
        float[] arr_f = this.values;
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            if(arr_f[v5] != ((IntFloatMap)object0).get(arr_v[v5])) {
                                return false;
                            }
                        }
                        v2 >>= 8;
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            function20.invoke(((int)arr_v[v5]), ((float)arr_f[v5]));
                        }
                        v2 >>= 8;
                    }
                    if(v3 == 8) {
    ...
    public final float getOrDefault(int v, float f) {
        int v1 = this.findKeyIndex(v);
        return v1 < 0 ? f : this.values[v1];
    }

    public final float getOrElse(int v, Function0 function00) {
    ...
    public final String joinToString() {
        return IntFloatMap.joinToString$default(this, null, null, null, 0, null, 0x1F, null);
    }

    public final String joinToString(CharSequence charSequence0) {
        Intrinsics.checkNotNullParameter(charSequence0, "separator");
        return IntFloatMap.joinToString$default(this, charSequence0, null, null, 0, null, 30, null);
    }
    ...
    public final String joinToString(CharSequence charSequence0, CharSequence charSequence1) {
        ...
        return IntFloatMap.joinToString$default(this, charSequence0, charSequence1, null, 0, null, 28, null);
    }
    ...
    public final String joinToString(CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2) {
        ...
        return IntFloatMap.joinToString$default(this, charSequence0, charSequence1, charSequence2, 0, null, 24, null);
    }
    ...
    public final String joinToString(CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v) {
        ...
        Intrinsics.checkNotNullParameter(charSequence1, "prefix");
        Intrinsics.checkNotNullParameter(charSequence2, "postfix");
        return IntFloatMap.joinToString$default(this, charSequence0, charSequence1, charSequence2, v, null, 16, null);
    }
    ...
    public static String joinToString$default(IntFloatMap intFloatMap0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, int v1, Object object0) {
        if(object0 != null) {
        ...
        return intFloatMap0.joinToString(charSequence0, charSequence1, charSequence2, v, charSequence3);
    }

    public static String joinToString$default(IntFloatMap intFloatMap0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, Function2 function20, int v1, Object object0) {
        long[] arr_v3;
        long[] arr_v2;
        if(object0 != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: joinToString");
        ...
        int[] arr_v = intFloatMap0.keys;
        float[] arr_f = intFloatMap0.values;
        long[] arr_v1 = intFloatMap0.metadata;
