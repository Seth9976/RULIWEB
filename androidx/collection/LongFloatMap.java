...
public abstract class LongFloatMap {
    ...
    public LongFloatMap(DefaultConstructorMarker defaultConstructorMarker0) {
    }
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            if(!((Boolean)function20.invoke(((long)arr_v[v5]), ((float)arr_f[v5]))).booleanValue()) {
                                return false;
                            }
                        }
                        v2 >>= 8;
    ...
    public final boolean containsKey(long v) {
        return this.findKeyIndex(v) >= 0;
    }
            ...
            for(int v1 = 0; true; ++v1) {
                ...
                if((~v3 << 7 & v3 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v5 = 0; v5 < v4; ++v5) {
                        if((0xFFL & v3) < 0x80L) {
                            int v6 = (v1 << 3) + v5;
                            if(((Boolean)function20.invoke(((long)arr_v[v6]), ((float)arr_f[v6]))).booleanValue()) {
                                ++v2;
                            }
                        }
                        v3 >>= 8;
    ...
    public boolean equals(Object object0) {
        ...
        if(((LongFloatMap)object0).getSize() != this.getSize()) {
            return false;
        }
        long[] arr_v = this.keys;
        float[] arr_f = this.values;
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) == 0x8080808080808080L) {
                    ...
                    while(v4 < v3) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            arr_v2 = arr_v;
                            if(arr_f[v5] != ((LongFloatMap)object0).get(arr_v2[v5])) {
                                return false;
                            }
                        }
                        else {
    ...
    public final int findKeyIndex(long v) {
        int v1 = (int)(v ^ v >>> 0x20);
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            function20.invoke(((long)arr_v[v5]), ((float)arr_f[v5]));
                        }
                        v2 >>= 8;
                    }
                    if(v3 == 8) {
    ...
    public final float getOrDefault(long v, float f) {
        int v1 = this.findKeyIndex(v);
        return v1 < 0 ? f : this.values[v1];
    }

    public final float getOrElse(long v, Function0 function00) {
        Intrinsics.checkNotNullParameter(function00, "defaultValue");
        int v1 = this.findKeyIndex(v);
        return v1 >= 0 ? this.values[v1] : ((Number)function00.invoke()).floatValue();
    }
            ...
            for(int v1 = 0; true; ++v1) {
                ...
                if((~v3 << 7 & v3 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v5 = 0; v5 < v4; ++v5) {
                        if((0xFFL & v3) < 0x80L) {
                            int v6 = (v1 << 3) + v5;
                            v2 += Float.floatToIntBits(arr_f[v6]) ^ UByte..ExternalSyntheticBackport0.m(arr_v[v6]);
                        }
                        v3 >>= 8;
                    }
                    if(v4 != 8) {
    ...
    public final String joinToString() {
        return LongFloatMap.joinToString$default(this, null, null, null, 0, null, 0x1F, null);
    }

    public final String joinToString(CharSequence charSequence0) {
        Intrinsics.checkNotNullParameter(charSequence0, "separator");
        return LongFloatMap.joinToString$default(this, charSequence0, null, null, 0, null, 30, null);
    }
    ...
    public final String joinToString(CharSequence charSequence0, CharSequence charSequence1) {
        ...
        return LongFloatMap.joinToString$default(this, charSequence0, charSequence1, null, 0, null, 28, null);
    }
    ...
    public final String joinToString(CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2) {
        ...
        return LongFloatMap.joinToString$default(this, charSequence0, charSequence1, charSequence2, 0, null, 24, null);
    }
    ...
    public final String joinToString(CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v) {
        ...
        Intrinsics.checkNotNullParameter(charSequence1, "prefix");
        Intrinsics.checkNotNullParameter(charSequence2, "postfix");
        return LongFloatMap.joinToString$default(this, charSequence0, charSequence1, charSequence2, v, null, 16, null);
    }
            ...
            while(true) {
                ...
                while(v7 < v6) {
                    if((v4 & 0xFFL) < 0x80L) {
                        ...
                        stringBuilder0.append(((CharSequence)function20.invoke(v9, f)));
                        ++v3;
                    }
                    v4 >>= 8;
                    ++v7;
            ...
            while(true) {
                ...
                while(v6 < v5) {
                    if((v3 & 0xFFL) < 0x80L) {
                        ...
                        stringBuilder0.append(((CharSequence)function20.invoke(v8, f)));
                        ++v2;
                    }
                    v3 >>= 8;
                    ++v6;
    ...
    public static String joinToString$default(LongFloatMap longFloatMap0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, int v1, Object object0) {
        if(object0 != null) {
        ...
        return longFloatMap0.joinToString(charSequence0, charSequence1, charSequence2, v, charSequence3);
    }

    public static String joinToString$default(LongFloatMap longFloatMap0, CharSequence charSequence0, CharSequence charSequence1, CharSequence charSequence2, int v, CharSequence charSequence3, Function2 function20, int v1, Object object0) {
        long[] arr_v3;
        long[] arr_v2;
        if(object0 != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: joinToString");
            ...
            while(true) {
                ...
                while(v8 < v7) {
                    if((v5 & 0xFFL) < 0x80L) {
                        ...
                        arr_v2 = arr_v1;
                        stringBuilder0.append(((CharSequence)function20.invoke(v10, f)));
                        ++v4;
                    }
                    else {
                        arr_v2 = arr_v1;
