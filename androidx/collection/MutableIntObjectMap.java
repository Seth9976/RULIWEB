...
public final class MutableIntObjectMap extends IntObjectMap {
    ...
    public MutableIntObjectMap(int v, int v1, DefaultConstructorMarker defaultConstructorMarker0) {
        if((v1 & 1) != 0) {
            v = 6;
        }
        this(v);
    ...
    public final Object getOrPut(int v, Function0 function00) {
    ...
    public final void plusAssign(IntObjectMap intObjectMap0) {
        Intrinsics.checkNotNullParameter(intObjectMap0, "from");
        this.putAll(intObjectMap0);
    }

    public final Object put(int v, Object object0) {
    ...
    public final void putAll(IntObjectMap intObjectMap0) {
        Intrinsics.checkNotNullParameter(intObjectMap0, "from");
    ...
    public final boolean remove(int v, Object object0) {
        int v10;
        int v1 = 0xCC9E2D51 * v ^ 0xCC9E2D51 * v << 16;
        int v2 = this._capacity;
        int v3 = v1 >>> 7 & v2;
            ...
            while(true) {
                ...
                if((~v2 << 7 & v2 & 0x8080808080808080L) != 0x8080808080808080L) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        if((0xFFL & v2) < 0x80L) {
                            int v5 = (v1 << 3) + v4;
                            if(((Boolean)function20.invoke(((int)this.keys[v5]), this.values[v5])).booleanValue()) {
