...
public final class ViewKt {
    public static final Fragment findFragment(View view0) {
        Intrinsics.checkNotNullParameter(view0, "$this$findFragment");
        Fragment fragment0 = FragmentManager.findFragment(view0);
        Intrinsics.checkNotNullExpressionValue(fragment0, "FragmentManager.findFragment(this)");
        return fragment0;
    }
}
