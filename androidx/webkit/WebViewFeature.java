...
public class WebViewFeature {
    ...
    public static boolean isFeatureSupported(String s) {
        return WebViewFeatureInternal.isSupported(s);
    }

    public static boolean isStartupFeatureSupported(Context context0, String s) {
        return WebViewFeatureInternal.isStartupFeatureSupported(s, context0);
    }
}
