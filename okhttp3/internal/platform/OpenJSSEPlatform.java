...
public final class OpenJSSEPlatform extends Platform {
    @Metadata(d1 = {"\u0000\u001A\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000B\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\b\u0010\u0006\u001A\u0004\u0018\u00010\u0007R\u0011\u0010\u0003\u001A\u00020\u0004¢\u0006\b\n\u0000\u001A\u0004\b\u0003\u0010\u0005¨\u0006\b"}, d2 = {"Lokhttp3/internal/platform/OpenJSSEPlatform$Companion;", "", "()V", "isSupported", "", "()Z", "buildIfSupported", "Lokhttp3/internal/platform/OpenJSSEPlatform;", "okhttp"}, k = 1, mv = {1, 7, 1}, xi = 0x30)
    ...
    public void configureTlsExtensions(SSLSocket sSLSocket0, String s, List list0) {
        ...
        if(sSLSocket0 instanceof org.openjsse.javax.net.ssl.SSLSocket) {
            SSLParameters sSLParameters0 = ((org.openjsse.javax.net.ssl.SSLSocket)sSLSocket0).getSSLParameters();
            if(sSLParameters0 instanceof org.openjsse.javax.net.ssl.SSLParameters) {
                ...
                ((org.openjsse.javax.net.ssl.SSLParameters)sSLParameters0).setApplicationProtocols(((String[])arr_object));
                ((org.openjsse.javax.net.ssl.SSLSocket)sSLSocket0).setSSLParameters(sSLParameters0);
            }
            return;
        }
    ...
    public String getSelectedProtocol(SSLSocket sSLSocket0) {
        Intrinsics.checkNotNullParameter(sSLSocket0, "sslSocket");
        if(sSLSocket0 instanceof org.openjsse.javax.net.ssl.SSLSocket) {
            String s = ((org.openjsse.javax.net.ssl.SSLSocket)sSLSocket0).getApplicationProtocol();
