...
public final class FirebaseAnalytics {
    ...
    public Task getAppInstanceId() {
        try {
            return Tasks.call(this.zzb(), new zzb(this));
        }
    ...
    public static FirebaseAnalytics getInstance(Context context0) {
        if(FirebaseAnalytics.zza == null) {
            Class class0 = FirebaseAnalytics.class;
            synchronized(class0) {
                if(FirebaseAnalytics.zza == null) {
                    FirebaseAnalytics.zza = new FirebaseAnalytics(zzef.zzg(context0, null, null, null, null));
                }
    ...
    public static zzil getScionFrontendApiImplementation(Context context0, Bundle bundle0) {
        zzef zzef0 = zzef.zzg(context0, null, null, null, bundle0);
        return zzef0 == null ? null : new zzd(zzef0);
    }

    public Task getSessionId() {
        try {
            return Tasks.call(this.zzb(), new zzc(this));
        }
        catch(RuntimeException runtimeException0) {
    ...
    public void setConsent(Map map0) {
    ...
    public void setUserProperty(String s, String s1) {
        this.zzb.zzO(null, s, s1, false);
    }
