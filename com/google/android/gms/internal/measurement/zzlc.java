...
final class zzlc extends zzjl implements zzlg, zzmp, RandomAccess {
    private static final zzlc zza;
    private int[] zzb;
    private int zzc;

    static {
        zzlc.zza = new zzlc(new int[0], 0, false);
    }
    ...
    private zzlc(int[] arr_v, int v, boolean z) {
        super(z);
        this.zzb = arr_v;
        this.zzc = v;
    }
    ...
    public final boolean addAll(Collection collection0) {
        ...
        if(!(collection0 instanceof zzlc)) {
            return super.addAll(collection0);
        }
        int v = ((zzlc)collection0).zzc;
        if(v == 0) {
            return false;
        }
        int v1 = this.zzc;
        ...
        System.arraycopy(((zzlc)collection0).zzb, 0, this.zzb, this.zzc, ((zzlc)collection0).zzc);
        this.zzc = v2;
        ++this.modCount;
        return true;
    }
    ...
    public final boolean equals(Object object0) {
        ...
        if(this.zzc != ((zzlc)object0).zzc) {
            return false;
        }
        int[] arr_v = ((zzlc)object0).zzb;
    ...
    public final zzlg zzg(int v) {
        ...
        return new zzlc(Arrays.copyOf(this.zzb, v), this.zzc, true);
    }
