...
final class zzku extends zzjl implements zzli, zzmp, RandomAccess {
    private static final zzku zza;
    private float[] zzb;
    private int zzc;

    static {
        zzku.zza = new zzku(new float[0], 0, false);
    }
    ...
    private zzku(float[] arr_f, int v, boolean z) {
        super(z);
        this.zzb = arr_f;
        this.zzc = v;
    }
    ...
    public final boolean addAll(Collection collection0) {
        ...
        System.arraycopy(((zzku)collection0).zzb, 0, this.zzb, this.zzc, ((zzku)collection0).zzc);
        this.zzc = v2;
        ++this.modCount;
        return true;
    }
    ...
    public final boolean equals(Object object0) {
        ...
        if(!(object0 instanceof zzku)) {
            return super.equals(object0);
        }
        if(this.zzc != ((zzku)object0).zzc) {
            return false;
        }
        float[] arr_f = ((zzku)object0).zzb;
    ...
    public final zzli zzd(int v) {
        ...
        return new zzku(Arrays.copyOf(this.zzb, v), this.zzc, true);
    }
