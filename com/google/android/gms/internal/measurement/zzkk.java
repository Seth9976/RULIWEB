...
final class zzkk extends zzjl implements zzli, zzmp, RandomAccess {
    private static final zzkk zza;
    private double[] zzb;
    private int zzc;

    static {
        zzkk.zza = new zzkk(new double[0], 0, false);
    }
    ...
    private zzkk(double[] arr_f, int v, boolean z) {
        super(z);
        this.zzb = arr_f;
        this.zzc = v;
    }
    ...
    public final boolean addAll(Collection collection0) {
        ...
        if(!(collection0 instanceof zzkk)) {
            return super.addAll(collection0);
        }
        int v = ((zzkk)collection0).zzc;
        if(v == 0) {
            return false;
        }
        int v1 = this.zzc;
        ...
        System.arraycopy(((zzkk)collection0).zzb, 0, this.zzb, this.zzc, ((zzkk)collection0).zzc);
        this.zzc = v2;
        ++this.modCount;
        return true;
    }
    ...
    public final boolean equals(Object object0) {
        ...
        if(this.zzc != ((zzkk)object0).zzc) {
            return false;
        }
        double[] arr_f = ((zzkk)object0).zzb;
    ...
    public final zzli zzd(int v) {
        ...
        return new zzkk(Arrays.copyOf(this.zzb, v), this.zzc, true);
    }
