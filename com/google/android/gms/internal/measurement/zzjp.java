...
final class zzjp extends zzjl implements zzli, zzmp, RandomAccess {
    private static final zzjp zza;
    private boolean[] zzb;
    private int zzc;

    static {
        zzjp.zza = new zzjp(new boolean[0], 0, false);
    }
    ...
    private zzjp(boolean[] arr_z, int v, boolean z) {
        super(z);
        this.zzb = arr_z;
        this.zzc = v;
    }
    ...
    public final boolean addAll(Collection collection0) {
        ...
        System.arraycopy(((zzjp)collection0).zzb, 0, this.zzb, this.zzc, ((zzjp)collection0).zzc);
        this.zzc = v2;
        ++this.modCount;
        return true;
    }
    ...
    public final boolean equals(Object object0) {
        ...
        if(this.zzc != ((zzjp)object0).zzc) {
            return false;
        }
        boolean[] arr_z = ((zzjp)object0).zzb;
    ...
    public final int hashCode() {
        int v1 = 1;
        for(int v = 0; v < this.zzc; ++v) {
            v1 = v1 * 0x1F + zzlj.zza(this.zzb[v]);
        }
        return v1;
    }
    ...
    public final zzli zzd(int v) {
        ...
        return new zzjp(Arrays.copyOf(this.zzb, v), this.zzc, true);
    }
