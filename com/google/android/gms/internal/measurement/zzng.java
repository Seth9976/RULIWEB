...
class zzng extends AbstractMap {
    ...
    public final boolean equals(Object object0) {
        ...
        if(!(object0 instanceof zzng)) {
            return super.equals(object0);
        }
        int v = this.size();
        if(v != ((zzng)object0).size()) {
            return false;
        }
        int v1 = this.zzb();
        if(v1 == ((zzng)object0).zzb()) {
            for(int v2 = 0; v2 < v1; ++v2) {
                if(!this.zzg(v2).equals(((zzng)object0).zzg(v2))) {
                    return false;
                }
            }
            return v1 == v ? true : this.zzc.equals(((zzng)object0).zzc);
        }
        return this.entrySet().equals(((zzng)object0).entrySet());
    }

    @Override
    public final Object get(Object object0) {
        int v = this.zzk(((Comparable)object0));
        return v < 0 ? this.zzc.get(((Comparable)object0)) : ((zzna)this.zzb.get(v)).getValue();
    }
    ...
    public final int hashCode() {
        ...
        for(int v1 = 0; v1 < v; ++v1) {
            v2 += ((zzna)this.zzb.get(v1)).hashCode();
        }
    ...
    public final Object zze(Comparable comparable0, Object object0) {
        ...
        if(v >= 0) {
            return ((zzna)this.zzb.get(v)).setValue(object0);
        }
        this.zzn();
        ...
        int v1 = this.zza;
        if(this.zzb.size() == v1) {
            zzna zzna0 = (zzna)this.zzb.remove(v1 - 1);
            this.zzm().put(zzna0.zza(), zzna0.getValue());
        }
        this.zzb.add(-(v + 1), new zzna(this, comparable0, object0));
        return null;
    }
    ...
    private final int zzk(Comparable comparable0) {
        ...
        int v2 = 0;
        if(v1 >= 0) {
            int v3 = comparable0.compareTo(((zzna)this.zzb.get(v1)).zza());
            if(v3 > 0) {
                return -(v + 1);
            }
            if(v3 == 0) {
        ...
        while(v2 <= v1) {
            int v4 = (v2 + v1) / 2;
            int v5 = comparable0.compareTo(((zzna)this.zzb.get(v4)).zza());
            if(v5 < 0) {
                v1 = v4 - 1;
                continue;
            }
    ...
    private final Object zzl(int v) {
        this.zzn();
        Object object0 = ((zzna)this.zzb.remove(v)).getValue();
        if(!this.zzc.isEmpty()) {
            Iterator iterator0 = this.zzm().entrySet().iterator();
            List list0 = this.zzb;
            Object object1 = iterator0.next();
            list0.add(new zzna(this, ((Comparable)((Map.Entry)object1).getKey()), ((Map.Entry)object1).getValue()));
            iterator0.remove();
        }
        return object0;
    }
