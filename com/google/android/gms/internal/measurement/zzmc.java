...
public final class zzmc extends LinkedHashMap {
    ...
    public final int hashCode() {
        ...
        for(Object object0: this.entrySet()) {
            int v1 = zzmc.zzf(((Map.Entry)object0).getKey());
            v += zzmc.zzf(((Map.Entry)object0).getValue()) ^ v1;
        }
        return v;
    }
    ...
    public final zzmc zzb() {
        return this.isEmpty() ? new zzmc() : new zzmc(this);
    }
    ...
    public final void zzd(zzmc zzmc0) {
        this.zzg();
        if(!zzmc0.isEmpty()) {
            this.putAll(zzmc0);
        }
    ...
    private static int zzf(Object object0) {
        if(object0 instanceof byte[]) {
            ...
            int v1 = zzlj.zzb(v, ((byte[])object0), 0, v);
            return v1 == 0 ? 1 : v1;
        }
        if(object0 instanceof zzld) {
