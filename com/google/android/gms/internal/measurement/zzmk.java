...
final class zzmk {
    ...
    static String zza(zzmi zzmi0, String s) {
        StringBuilder stringBuilder0 = new StringBuilder();
        stringBuilder0.append("# ");
        stringBuilder0.append(s);
        zzmk.zzd(zzmi0, stringBuilder0, 0);
    ...
    static void zzb(StringBuilder stringBuilder0, int v, String s, Object object0) {
        if(object0 instanceof List) {
            for(Object object1: ((List)object0)) {
                zzmk.zzb(stringBuilder0, v, s, object1);
            }
            return;
        }
        if(object0 instanceof Map) {
            for(Object object2: ((Map)object0).entrySet()) {
                zzmk.zzb(stringBuilder0, v, s, ((Map.Entry)object2));
            }
            return;
        }
        stringBuilder0.append('\n');
        zzmk.zzc(v, stringBuilder0);
        if(!s.isEmpty()) {
        ...
        if(object0 instanceof String) {
            stringBuilder0.append(": \"");
            stringBuilder0.append(zzni.zza(new zzjx(((String)object0).getBytes(zzlj.zzb))));
            stringBuilder0.append('\"');
            return;
        }
        if(object0 instanceof zzka) {
            stringBuilder0.append(": \"");
            stringBuilder0.append(zzni.zza(((zzka)object0)));
            stringBuilder0.append('\"');
            return;
        }
        if(object0 instanceof zzlb) {
            stringBuilder0.append(" {");
            zzmk.zzd(((zzlb)object0), stringBuilder0, v + 2);
            stringBuilder0.append("\n");
            zzmk.zzc(v, stringBuilder0);
            stringBuilder0.append("}");
            return;
        ...
        if(object0 instanceof Map.Entry) {
            stringBuilder0.append(" {");
            zzmk.zzb(stringBuilder0, v + 2, "key", ((Map.Entry)object0).getKey());
            zzmk.zzb(stringBuilder0, v + 2, "value", ((Map.Entry)object0).getValue());
            stringBuilder0.append("\n");
            zzmk.zzc(v, stringBuilder0);
            stringBuilder0.append("}");
            return;
    ...
    private static void zzc(int v, StringBuilder stringBuilder0) {
        while(true) {
            ...
            stringBuilder0.append(zzmk.zza, 0, v1);
            v -= v1;
        }
    }

    private static void zzd(zzmi zzmi0, StringBuilder stringBuilder0, int v) {
        boolean z;
        HashSet hashSet0 = new HashSet();
        HashMap hashMap0 = new HashMap();
        TreeMap treeMap0 = new TreeMap();
        Method[] arr_method = zzmi0.getClass().getDeclaredMethods();
        ...
        for(Object object0: treeMap0.entrySet()) {
            ...
            if(s.endsWith("List") && !s.endsWith("OrBuilderList") && !s.equals("List")) {
                ...
                if(method1 != null && method1.getReturnType().equals(List.class)) {
                    zzmk.zzb(stringBuilder0, v, s.substring(0, s.length() - 4), zzlb.zzbK(method1, zzmi0, new Object[0]));
                    continue;
                }
            }
            if(s.endsWith("Map") && !s.equals("Map")) {
                ...
                if(method2 != null && method2.getReturnType().equals(Map.class) && !method2.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method2.getModifiers())) {
                    zzmk.zzb(stringBuilder0, v, s.substring(0, s.length() - 3), zzlb.zzbK(method2, zzmi0, new Object[0]));
                    continue;
                }
            }
            if(hashSet0.contains("set" + s) && (!s.endsWith("Bytes") || !treeMap0.containsKey("get" + s.substring(0, s.length() - 5)))) {
                ...
                if(method3 != null) {
                    Object object1 = zzlb.zzbK(method3, zzmi0, new Object[0]);
                    if(method4 == null) {
                        if(object1 instanceof Boolean) {
                            ...
                            if(object1 instanceof zzka) {
                                z = object1.equals(zzka.zzb);
                            label_57:
                                if(z) {
                                    continue;
                                }
                            }
                            else if(object1 instanceof zzmi) {
                                if(object1 == ((zzmi)object1).zzbV()) {
                                    continue;
                                }
                            }
                    ...
                    label_64:
                        if(((Boolean)zzlb.zzbK(method4, zzmi0, new Object[0])).booleanValue()) {
                            goto label_65;
                        }
                        continue;
                    }
        ...
        if(!(zzmi0 instanceof zzky)) {
            zznl zznl0 = ((zzlb)zzmi0).zzc;
            if(zznl0 != null) {
                zznl0.zzi(stringBuilder0, v);
            }
            return;
        }
        zzky zzky0 = (zzky)zzmi0;
        throw null;
    }
}
