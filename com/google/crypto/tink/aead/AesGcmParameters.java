...
public final class AesGcmParameters extends AeadParameters {
    public static final class Builder {
        ...
        Builder(com.google.crypto.tink.aead.AesGcmParameters.1 aesGcmParameters$10) {
        }
        ...
        public AesGcmParameters build() throws GeneralSecurityException {
            ...
            return new AesGcmParameters(((int)this.keySizeBytes), ((int)this.ivSizeBytes), ((int)this.tagSizeBytes), this.variant, null);
        }
        ...
        public Builder setVariant(Variant aesGcmParameters$Variant0) {
            this.variant = aesGcmParameters$Variant0;
            return this;
        }
    }
    ...
    private AesGcmParameters(int v, int v1, int v2, Variant aesGcmParameters$Variant0) {
        this.keySizeBytes = v;
        this.ivSizeBytes = v1;
    ...
    AesGcmParameters(int v, int v1, int v2, Variant aesGcmParameters$Variant0, com.google.crypto.tink.aead.AesGcmParameters.1 aesGcmParameters$10) {
        this(v, v1, v2, aesGcmParameters$Variant0);
    }
    ...
    public boolean equals(Object object0) {
        return object0 instanceof AesGcmParameters ? ((AesGcmParameters)object0).getKeySizeBytes() == this.getKeySizeBytes() && ((AesGcmParameters)object0).getIvSizeBytes() == this.getIvSizeBytes() && ((AesGcmParameters)object0).getTagSizeBytes() == this.getTagSizeBytes() && ((AesGcmParameters)object0).getVariant() == this.getVariant() : false;
    }
    ...
    class com.google.crypto.tink.aead.AesGcmParameters.1 {
    }
