...
final class JsonUtf8Reader extends JsonReader {
    ...
    JsonUtf8Reader(JsonUtf8Reader jsonUtf8Reader0) {
        super(jsonUtf8Reader0);
        this.peeked = 0;
        BufferedSource bufferedSource0 = jsonUtf8Reader0.source.peek();
        this.source = bufferedSource0;
        this.buffer = bufferedSource0.getBuffer();
        this.peeked = jsonUtf8Reader0.peeked;
        this.peekedLong = jsonUtf8Reader0.peekedLong;
        this.peekedNumberLength = jsonUtf8Reader0.peekedNumberLength;
        this.peekedString = jsonUtf8Reader0.peekedString;
        try {
            bufferedSource0.require(jsonUtf8Reader0.buffer.size());
        }
    ...
    JsonUtf8Reader(BufferedSource bufferedSource0) {
        this.peeked = 0;
    ...
    public void beginArray() throws IOException {
        if((this.peeked == 0 ? this.doPeek() : this.peeked) != 3) {
            throw new JsonDataException("Expected BEGIN_ARRAY but was " + this.peek() + " at path " + this.getPath());
        }
        this.pushScope(1);
    ...
    public void beginObject() throws IOException {
        if((this.peeked == 0 ? this.doPeek() : this.peeked) != 1) {
            throw new JsonDataException("Expected BEGIN_OBJECT but was " + this.peek() + " at path " + this.getPath());
        }
        this.pushScope(3);
        this.peeked = 0;
    }
    ...
    private int doPeek() throws IOException {
        int v = this.scopes[this.stackSize - 1];
        if(v == 1) {
            this.scopes[this.stackSize - 1] = 2;
            goto label_37;
        }
        if(v == 2) {
            int v1 = this.nextNonWhitespace(true);
        ...
        label_37:
            ...
            if(v3 != 34) {
                switch(v3) {
                    ...
                    default: {
                        if(v3 != 0x7B) {
                            int v4 = this.peekKeyword();
                            if(v4 != 0) {
                                return v4;
                            }
                            int v5 = this.peekNumber();
                            if(v5 != 0) {
                                return v5;
                            }
        ...
        if(v == 5) {
            int v6 = this.nextNonWhitespace(true);
            this.buffer.readByte();
            switch(v6) {
                case 44: {
                    break;
    ...
    public void endArray() throws IOException {
        if((this.peeked == 0 ? this.doPeek() : this.peeked) != 4) {
            throw new JsonDataException("Expected END_ARRAY but was " + this.peek() + " at path " + this.getPath());
        }
        --this.stackSize;
    ...
    public void endObject() throws IOException {
        if((this.peeked == 0 ? this.doPeek() : this.peeked) != 2) {
            throw new JsonDataException("Expected END_OBJECT but was " + this.peek() + " at path " + this.getPath());
        }
        --this.stackSize;
    ...
    private int findString(String s, Options jsonReader$Options0) {
        for(int v = 0; v < jsonReader$Options0.strings.length; ++v) {
            if(s.equals(jsonReader$Options0.strings[v])) {
                this.peeked = 0;
    ...
    private boolean isLiteral(int v) throws IOException {
        switch(v) {
            case 35: 
            case 0x2F: 
            case 59: 
    ...
    public boolean nextBoolean() throws IOException {
        switch((this.peeked == 0 ? this.doPeek() : this.peeked)) {
            ...
            default: {
                throw new JsonDataException("Expected a boolean but was " + this.peek() + " at path " + this.getPath());
            }
        }
    }
        ...
        switch(this.peeked) {
            case 0: {
                switch(this.doPeek()) {
                    ...
                    default: {
                        throw new JsonDataException("Expected a double but was " + this.peek() + " at path " + this.getPath());
                    }
                }
            }
            case 8: {
    ...
    public int nextInt() throws IOException {
        ...
        switch(v) {
            ...
            default: {
                throw new JsonDataException("Expected an int but was " + this.peek() + " at path " + this.getPath());
            }
        }
        try {
            this.peeked = 11;
    ...
    public long nextLong() throws IOException {
        ...
        switch(v) {
            ...
            default: {
                throw new JsonDataException("Expected a long but was " + this.peek() + " at path " + this.getPath());
            }
        }
        try {
            this.peeked = 11;
            v4 = new BigDecimal(this.peekedString).longValueExact();
        }
        ...
        switch(this.peeked) {
            case 0: {
                switch(this.doPeek()) {
                    ...
                    default: {
                        throw new JsonDataException("Expected a name but was " + this.peek() + " at path " + this.getPath());
                    }
                }
            }
            case 12: {
    ...
    public Object nextNull() throws IOException {
        if((this.peeked == 0 ? this.doPeek() : this.peeked) != 7) {
            throw new JsonDataException("Expected null but was " + this.peek() + " at path " + this.getPath());
        }
        this.peeked = 0;
        int v = this.stackSize - 1;
        ++this.pathIndices[v];
    ...
    private String nextQuotedValue(ByteString byteString0) throws IOException {
    ...
    public BufferedSource nextSource() throws IOException {
        ...
        switch(v) {
            case 1: {
                buffer0.writeUtf8("{");
                byteString0 = JsonValueSource.STATE_JSON;
                v1 = 1;
                break;
            }
            case 3: {
            ...
            case 8: {
                buffer0.writeUtf8("\'");
                byteString0 = JsonValueSource.STATE_SINGLE_QUOTED;
                v1 = 0;
                break;
            }
            case 9: {
                buffer0.writeUtf8("\"");
                byteString0 = JsonValueSource.STATE_DOUBLE_QUOTED;
                v1 = 0;
                break;
            }
            case 11: {
        ...
        this.valueSource = new JsonValueSource(this.source, buffer0, byteString0, v1);
        this.pushScope(9);
        ...
        switch(this.peeked) {
            case 0: {
                switch(this.doPeek()) {
                    ...
                    default: {
                        throw new JsonDataException("Expected a string but was " + this.peek() + " at path " + this.getPath());
                    }
                }
            }
            case 8: {
    ...
    private int peekNumber() throws IOException {
        ...
        boolean z = false;
    alab1:
        while(this.source.request(((long)(v + 1)))) {
            int v4 = this.buffer.getByte(((long)v));
            switch(v4) {
                case 43: {
                    if(v1 != 5) {
                        return 0;
        ...
        if(v1 == 2 && v2 != 0 && (v3 != 0x8000000000000000L || z) && (v3 != 0L || !z)) {
            if(!z) {
                v3 = -v3;
            }
            this.peekedLong = v3;
    ...
    public int selectString(Options jsonReader$Options0) throws IOException {
        ...
        if(v >= 8 && v <= 11) {
            if(v == 11) {
                return this.findString(this.peekedString, jsonReader$Options0);
            }
            int v1 = this.source.select(jsonReader$Options0.doubleQuoteSuffix);
            if(v1 != -1) {
                this.peeked = 0;
            ...
            String s = this.nextString();
            int v3 = this.findString(s, jsonReader$Options0);
            if(v3 == -1) {
                this.peeked = 11;
                this.peekedString = s;
                int v4 = this.stackSize - 1;
    ...
    private void skipQuotedValue(ByteString byteString0) throws IOException {
        long v;
        while((v = this.source.indexOfElement(byteString0)) != -1L) {
            if(this.buffer.getByte(v) == 92) {
