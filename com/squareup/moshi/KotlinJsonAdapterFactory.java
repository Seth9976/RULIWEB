...
public final class KotlinJsonAdapterFactory implements Factory {
    private final com.squareup.moshi.kotlin.reflect.KotlinJsonAdapterFactory $$delegate_0;

    public KotlinJsonAdapterFactory() {
        this.$$delegate_0 = new com.squareup.moshi.kotlin.reflect.KotlinJsonAdapterFactory();
    }
    ...
    public JsonAdapter create(Type type0, Set set0, Moshi moshi0) {
        return this.$$delegate_0.create(type0, set0, moshi0);
    }
}
