...
@Metadata(d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010%\n\u0002\u0010\u000E\n\u0002\u0010\u000B\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0003\n\u0002\b\u0002\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J \u0010\u0007\u001A\u00020\u00062\u0006\u0010\b\u001A\u00020\t2\u0006\u0010\n\u001A\u00020\u00052\u0006\u0010\u000B\u001A\u00020\fH\u0016J\u0010\u0010\r\u001A\u00020\u00062\u0006\u0010\u000B\u001A\u00020\fH\u0002R\u001A\u0010\u0003\u001A\u000E\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\u00060\u0004X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u000E"}, d2 = {"Lcom/navercorp/nid/preference/IncompatibleSharedPreferencesWorkaround;", "Lcom/navercorp/nid/preference/EncryptedSharedPreferenceWorkaround;", "()V", "statusMap", "", "", "", "apply", "context", "Landroid/content/Context;", "fileName", "throwable", "", "isIncompatibleError", "Nid-OAuth_release"}, k = 1, mv = {1, 6, 0}, xi = 0x30)
public final class IncompatibleSharedPreferencesWorkaround implements EncryptedSharedPreferenceWorkaround {
    ...
    public IncompatibleSharedPreferencesWorkaround() {
    ...
    public boolean apply(Context context0, String s, Throwable throwable0) {
        ...
        if(!this.isIncompatibleError(throwable0)) {
            return false;
        }
    ...
    private final boolean isIncompatibleError(Throwable throwable0) {
        return StringsKt.contains$default(throwable0.toString(), "InvalidProtocolBufferException", false, 2, null);
    }
}
