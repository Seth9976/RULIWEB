...
public enum ErrorTypeKind {
    ...
    private static final ErrorTypeKind[] $values() [...] // Inlined contents

    private ErrorTypeKind(String s1, boolean z) {
        this.debugMessage = s1;
        this.isUnresolved = z;
    }

    ErrorTypeKind(String s1, boolean z, int v1, DefaultConstructorMarker defaultConstructorMarker0) {
        if((v1 & 2) != 0) {
            z = false;
        }
        this(s1, z);
