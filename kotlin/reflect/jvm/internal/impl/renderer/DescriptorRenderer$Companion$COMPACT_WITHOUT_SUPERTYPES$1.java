...
final class DescriptorRenderer.Companion.COMPACT_WITHOUT_SUPERTYPES.1 extends Lambda implements Function1 {
    public static final DescriptorRenderer.Companion.COMPACT_WITHOUT_SUPERTYPES.1 INSTANCE;

    static {
        DescriptorRenderer.Companion.COMPACT_WITHOUT_SUPERTYPES.1.INSTANCE = new DescriptorRenderer.Companion.COMPACT_WITHOUT_SUPERTYPES.1();
    }
