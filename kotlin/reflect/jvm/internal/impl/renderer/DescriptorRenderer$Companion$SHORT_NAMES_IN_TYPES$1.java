...
final class DescriptorRenderer.Companion.SHORT_NAMES_IN_TYPES.1 extends Lambda implements Function1 {
    public static final DescriptorRenderer.Companion.SHORT_NAMES_IN_TYPES.1 INSTANCE;

    static {
        DescriptorRenderer.Companion.SHORT_NAMES_IN_TYPES.1.INSTANCE = new DescriptorRenderer.Companion.SHORT_NAMES_IN_TYPES.1();
    }
