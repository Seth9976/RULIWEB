...
final class PredefinedEnhancementInfoKt.PREDEFINED_FUNCTION_ENHANCEMENT_INFO_BY_SIGNATURE.1.1.8.1 extends Lambda implements Function1 {
    final String $JLObject;

    PredefinedEnhancementInfoKt.PREDEFINED_FUNCTION_ENHANCEMENT_INFO_BY_SIGNATURE.1.1.8.1(String s) {
        this.$JLObject = s;
        super(1);
    }
