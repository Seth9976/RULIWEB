...
final class PredefinedEnhancementInfoKt.PREDEFINED_FUNCTION_ENHANCEMENT_INFO_BY_SIGNATURE.1.1.6.1 extends Lambda implements Function1 {
    final String $JUOptional;

    PredefinedEnhancementInfoKt.PREDEFINED_FUNCTION_ENHANCEMENT_INFO_BY_SIGNATURE.1.1.6.1(String s) {
        this.$JUOptional = s;
        super(1);
    }
