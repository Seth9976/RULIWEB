...
final class PredefinedEnhancementInfoKt.PREDEFINED_FUNCTION_ENHANCEMENT_INFO_BY_SIGNATURE.1.1.6.2 extends Lambda implements Function1 {
    final String $JLObject;
    final String $JUOptional;

    PredefinedEnhancementInfoKt.PREDEFINED_FUNCTION_ENHANCEMENT_INFO_BY_SIGNATURE.1.1.6.2(String s, String s1) {
        this.$JLObject = s;
        this.$JUOptional = s1;
        super(1);
    }
