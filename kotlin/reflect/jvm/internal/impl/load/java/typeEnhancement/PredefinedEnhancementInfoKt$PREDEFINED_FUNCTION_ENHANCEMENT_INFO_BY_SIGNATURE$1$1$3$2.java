...
final class PredefinedEnhancementInfoKt.PREDEFINED_FUNCTION_ENHANCEMENT_INFO_BY_SIGNATURE.1.1.3.2 extends Lambda implements Function1 {
    final String $JUStream;

    PredefinedEnhancementInfoKt.PREDEFINED_FUNCTION_ENHANCEMENT_INFO_BY_SIGNATURE.1.1.3.2(String s) {
        this.$JUStream = s;
        super(1);
    }
