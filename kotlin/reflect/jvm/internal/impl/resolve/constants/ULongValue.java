...
public final class ULongValue extends UnsignedValueConstant {
    ...
    public KotlinType getType(ModuleDescriptor moduleDescriptor0) {
        ...
        ClassDescriptor classDescriptor0 = FindClassInModuleKt.findClassAcrossModuleDependencies(moduleDescriptor0, FqNames.uLong);
        SimpleType simpleType0 = classDescriptor0 == null ? null : classDescriptor0.getDefaultType();
        return simpleType0 == null ? ErrorUtils.createErrorType(ErrorTypeKind.NOT_FOUND_UNSIGNED_TYPE, new String[]{"ULong"}) : simpleType0;
    }
