...
public abstract class CallerImpl implements Caller {
    ...
    public static final class AccessorForHiddenBoundConstructor extends CallerImpl implements BoundCaller {
        ...
        public AccessorForHiddenBoundConstructor(Constructor constructor0, Object object0) {
            ...
            Type[] arr_type1 = arr_type.length <= 2 ? new Type[0] : ArraysKt.copyOfRange(arr_type, 1, arr_type.length - 1);
        ...
        public Object call(Object[] arr_object) {
            ...
            Constructor constructor0 = (Constructor)this.getMember();
            SpreadBuilder spreadBuilder0 = new SpreadBuilder(3);
            spreadBuilder0.add(this.boundReceiver);
            spreadBuilder0.addSpread(arr_object);
            spreadBuilder0.add(null);
            return constructor0.newInstance(spreadBuilder0.toArray(new Object[spreadBuilder0.size()]));
        }
    }
    ...
    public static final class AccessorForHiddenConstructor extends CallerImpl {
        public AccessorForHiddenConstructor(Constructor constructor0) {
            Intrinsics.checkNotNullParameter(constructor0, "constructor");
            Class class0 = constructor0.getDeclaringClass();
            Intrinsics.checkNotNullExpressionValue(class0, "constructor.declaringClass");
            Type[] arr_type = constructor0.getGenericParameterTypes();
            Intrinsics.checkNotNullExpressionValue(arr_type, "constructor.genericParameterTypes");
            Type[] arr_type1 = arr_type.length <= 1 ? new Type[0] : ArraysKt.copyOfRange(arr_type, 0, arr_type.length - 1);
            super(constructor0, class0, null, arr_type1, null);
        }
    ...
    public static final class BoundConstructor extends CallerImpl implements BoundCaller {
        ...
        public BoundConstructor(Constructor constructor0, Object object0) {
            Intrinsics.checkNotNullParameter(constructor0, "constructor");
            Class class0 = constructor0.getDeclaringClass();
            Intrinsics.checkNotNullExpressionValue(class0, "constructor.declaringClass");
            Type[] arr_type = constructor0.getGenericParameterTypes();
    ...
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0011\n\u0002\b\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J(\u0010\u0003\u001A\b\u0012\u0004\u0012\u0002H\u00050\u0004\"\u0006\b\u0001\u0010\u0005\u0018\u0001*\n\u0012\u0006\b\u0001\u0012\u0002H\u00050\u0004H\u0086\b¢\u0006\u0002\u0010\u0006J(\u0010\u0007\u001A\b\u0012\u0004\u0012\u0002H\u00050\u0004\"\u0006\b\u0001\u0010\u0005\u0018\u0001*\n\u0012\u0006\b\u0001\u0012\u0002H\u00050\u0004H\u0086\b¢\u0006\u0002\u0010\u0006J(\u0010\b\u001A\b\u0012\u0004\u0012\u0002H\u00050\u0004\"\u0006\b\u0001\u0010\u0005\u0018\u0001*\n\u0012\u0006\b\u0001\u0012\u0002H\u00050\u0004H\u0086\b¢\u0006\u0002\u0010\u0006¨\u0006\t"}, d2 = {"Lkotlin/reflect/jvm/internal/calls/CallerImpl$Companion;", "", "()V", "dropFirst", "", "T", "([Ljava/lang/Object;)[Ljava/lang/Object;", "dropFirstAndLast", "dropLast", "kotlin-reflection"}, k = 1, mv = {1, 8, 0}, xi = 0x30)
    ...
    public static final class kotlin.reflect.jvm.internal.calls.CallerImpl.Constructor extends CallerImpl {
        public kotlin.reflect.jvm.internal.calls.CallerImpl.Constructor(Constructor constructor0) {
            Intrinsics.checkNotNullParameter(constructor0, "constructor");
            Class class0 = constructor0.getDeclaringClass();
            Intrinsics.checkNotNullExpressionValue(class0, "constructor.declaringClass");
            Class class1 = constructor0.getDeclaringClass();
            Class class2 = class1.getDeclaringClass();
            if(class2 == null || Modifier.isStatic(class1.getModifiers())) {
                class2 = null;
            }
            Type[] arr_type = constructor0.getGenericParameterTypes();
            Intrinsics.checkNotNullExpressionValue(arr_type, "constructor.genericParameterTypes");
            super(constructor0, class0, class2, arr_type, null);
        }
    ...
    public static abstract class FieldGetter extends CallerImpl {
        ...
        public static final class BoundInstance extends FieldGetter implements BoundCaller {
            ...
            public BoundInstance(Field field0, Object object0) {
        ...
        public static final class BoundJvmStaticInObject extends FieldGetter implements BoundCaller {
            public BoundJvmStaticInObject(Field field0) {
                Intrinsics.checkNotNullParameter(field0, "field");
                super(field0, false, null);
            }
        }
        ...
        public static final class JvmStaticInObject extends FieldGetter {
            public JvmStaticInObject(Field field0) {
                Intrinsics.checkNotNullParameter(field0, "field");
                super(field0, true, null);
            }
            ...
            public void checkArguments(Object[] arr_object) {
                ...
                this.checkObjectInstance(ArraysKt.firstOrNull(arr_object));
            }
        }
        ...
        private FieldGetter(Field field0, boolean z) {
        ...
        public Object call(Object[] arr_object) {
            ...
            return this.getInstanceClass() == null ? field0.get(null) : field0.get(ArraysKt.first(arr_object));
        }
    }
    ...
    public static abstract class FieldSetter extends CallerImpl {
        ...
        public static final class kotlin.reflect.jvm.internal.calls.CallerImpl.FieldSetter.BoundInstance extends FieldSetter implements BoundCaller {
            ...
            public kotlin.reflect.jvm.internal.calls.CallerImpl.FieldSetter.BoundInstance(Field field0, boolean z, Object object0) {
                Intrinsics.checkNotNullParameter(field0, "field");
            ...
            public Object call(Object[] arr_object) {
                ...
                this.checkArguments(arr_object);
                Field field0 = (Field)this.getMember();
                Object object0 = ArraysKt.first(arr_object);
                field0.set(this.boundReceiver, object0);
        ...
        public static final class kotlin.reflect.jvm.internal.calls.CallerImpl.FieldSetter.BoundJvmStaticInObject extends FieldSetter implements BoundCaller {
            public kotlin.reflect.jvm.internal.calls.CallerImpl.FieldSetter.BoundJvmStaticInObject(Field field0, boolean z) {
                Intrinsics.checkNotNullParameter(field0, "field");
                super(field0, z, false, null);
            }
            ...
            public Object call(Object[] arr_object) {
                Intrinsics.checkNotNullParameter(arr_object, "args");
                this.checkArguments(arr_object);
                ((Field)this.getMember()).set(null, ArraysKt.last(arr_object));
                return Unit.INSTANCE;
            }
        }
        ...
        public static final class kotlin.reflect.jvm.internal.calls.CallerImpl.FieldSetter.Instance extends FieldSetter {
            public kotlin.reflect.jvm.internal.calls.CallerImpl.FieldSetter.Instance(Field field0, boolean z) {
                Intrinsics.checkNotNullParameter(field0, "field");
        ...
        public static final class kotlin.reflect.jvm.internal.calls.CallerImpl.FieldSetter.JvmStaticInObject extends FieldSetter {
            public kotlin.reflect.jvm.internal.calls.CallerImpl.FieldSetter.JvmStaticInObject(Field field0, boolean z) {
                Intrinsics.checkNotNullParameter(field0, "field");
                super(field0, z, true, null);
            }
        ...
        public static final class kotlin.reflect.jvm.internal.calls.CallerImpl.FieldSetter.Static extends FieldSetter {
            public kotlin.reflect.jvm.internal.calls.CallerImpl.FieldSetter.Static(Field field0, boolean z) {
                Intrinsics.checkNotNullParameter(field0, "field");
                super(field0, z, false, null);
            }
        }
        ...
        private FieldSetter(Field field0, boolean z, boolean z1) {
        ...
        public Object call(Object[] arr_object) {
            Intrinsics.checkNotNullParameter(arr_object, "args");
            this.checkArguments(arr_object);
            ((Field)this.getMember()).set((this.getInstanceClass() == null ? null : ArraysKt.first(arr_object)), ArraysKt.last(arr_object));
            return Unit.INSTANCE;
        }
        ...
        public void checkArguments(Object[] arr_object) {
            Intrinsics.checkNotNullParameter(arr_object, "args");
            super.checkArguments(arr_object);
            if(this.notNull && ArraysKt.last(arr_object) == null) {
    ...
    public static abstract class Method extends CallerImpl {
        ...
        public static final class kotlin.reflect.jvm.internal.calls.CallerImpl.Method.BoundInstance extends Method implements BoundCaller {
            ...
            public kotlin.reflect.jvm.internal.calls.CallerImpl.Method.BoundInstance(java.lang.reflect.Method method0, Object object0) {
        ...
        public static final class kotlin.reflect.jvm.internal.calls.CallerImpl.Method.BoundJvmStaticInObject extends Method implements BoundCaller {
            public kotlin.reflect.jvm.internal.calls.CallerImpl.Method.BoundJvmStaticInObject(java.lang.reflect.Method method0) {
                Intrinsics.checkNotNullParameter(method0, "method");
                super(method0, false, null, 4, null);
            }
        ...
        public static final class BoundStatic extends Method implements BoundCaller {
            ...
            public BoundStatic(java.lang.reflect.Method method0, Object object0) {
                Intrinsics.checkNotNullParameter(method0, "method");
                ...
                Type[] arr_type1 = arr_type.length <= 1 ? new Type[0] : ArraysKt.copyOfRange(arr_type, 1, arr_type.length);
        ...
        public static final class kotlin.reflect.jvm.internal.calls.CallerImpl.Method.Instance extends Method {
            public kotlin.reflect.jvm.internal.calls.CallerImpl.Method.Instance(java.lang.reflect.Method method0) {
                Intrinsics.checkNotNullParameter(method0, "method");
        ...
        public static final class kotlin.reflect.jvm.internal.calls.CallerImpl.Method.JvmStaticInObject extends Method {
            public kotlin.reflect.jvm.internal.calls.CallerImpl.Method.JvmStaticInObject(java.lang.reflect.Method method0) {
                Intrinsics.checkNotNullParameter(method0, "method");
            ...
            public Object call(Object[] arr_object) {
                ...
                this.checkArguments(arr_object);
                this.checkObjectInstance(ArraysKt.firstOrNull(arr_object));
                return arr_object.length > 1 ? this.callMethod(null, ArraysKt.copyOfRange(arr_object, 1, arr_object.length)) : this.callMethod(null, new Object[0]);
            }
        }
        ...
        public static final class kotlin.reflect.jvm.internal.calls.CallerImpl.Method.Static extends Method {
            public kotlin.reflect.jvm.internal.calls.CallerImpl.Method.Static(java.lang.reflect.Method method0) {
                Intrinsics.checkNotNullParameter(method0, "method");
                super(method0, false, null, 6, null);
            }
        ...
        private Method(java.lang.reflect.Method method0, boolean z, Type[] arr_type) {
        ...
        protected final Object callMethod(Object object0, Object[] arr_object) {
            ...
            return this.isVoidMethod ? Unit.INSTANCE : unit0;
        }
    }
    ...
    private CallerImpl(Member member0, Type type0, Class class0, Type[] arr_type) {
        List list0;
        this.member = member0;
        this.returnType = type0;
        this.instanceClass = class0;
        if(class0 == null) {
            list0 = ArraysKt.toList(arr_type);
        }
        else {
            SpreadBuilder spreadBuilder0 = new SpreadBuilder(2);
            spreadBuilder0.add(class0);
            spreadBuilder0.addSpread(arr_type);
            list0 = CollectionsKt.listOf(spreadBuilder0.toArray(new Type[spreadBuilder0.size()]));
            if(list0 == null) {
                list0 = ArraysKt.toList(arr_type);
            }
        }
    ...
    public CallerImpl(Member member0, Type type0, Class class0, Type[] arr_type, DefaultConstructorMarker defaultConstructorMarker0) {
        this(member0, type0, class0, arr_type);
    }
    ...
    protected final void checkObjectInstance(Object object0) {
        if(object0 == null || !this.member.getDeclaringClass().isInstance(object0)) {
